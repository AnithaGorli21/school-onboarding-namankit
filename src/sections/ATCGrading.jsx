...
export default function ATCGrading({ school, onBack }) {
  ...
  const handleSubmit = async (approvalStatus) => {
    ...
    try {
      ...
      // Update each question's atcMarks and atcRemarks
            ...
            <div style={{ padding: "10px 14px" }}>
              ...
              <div style={{ marginBottom: 8 }}>
                ...
                <input type="number" step="0.01" min="0" max={q.maxMarks}
                  value={questionData[idx]?.atcMarks || 0}
                  onChange={e => updateQ(idx, "atcMarks", parseFloat(e.target.value) || 0)}
