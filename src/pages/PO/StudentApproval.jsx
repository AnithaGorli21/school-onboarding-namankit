  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const mapped = (items || []).map((it) => ({
        ...
        name:
          it.studentName || `${it.firstName || ""} ${it.lastName || ""}`.trim(),
      ...
      <div style={{ padding: 18 }}>
          ...
          <div>
            ...
            <select
              ...
              style={{
                padding: 8,
                minWidth: 240,
                borderColor: schoolError ? "#e53935" : undefined,
              }}
            >
              ...
              {rows.length === 0 ? (
                ...
                paged.map((r, i) => (
                  <tr key={r.id || i}>
                    ...
                    <td style={tdStyle}>
                      <button style={linkBtn}>View</button>
                    </td>
                    ...
                    <td style={tdStyle}>
                      {r.status === "approved" || r.status === "rejected" ? (
                        <span
                          style={{
                            color:
                              r.status === "approved" ? "#28a745" : "#dc3545",
                            fontWeight: 600,
                          }}
                        >
                          {r.status === "approved"
        ...
        <div style={{ marginTop: 14, display: "flex", gap: 8 }}>
          <button
            ...
            disabled={saving}
            style={{
              background: saving ? "#6cbe89" : "#28a745",
              color: "#fff",
              border: "none",
              padding: "8px 12px",
              borderRadius: 4,
